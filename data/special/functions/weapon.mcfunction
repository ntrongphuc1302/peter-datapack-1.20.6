...
execute as @a[nbt={SelectedItem:{id:"minecraft:bow",count:1,components:{"minecraft:custom_model_data":3}}}] at @s if entity @e[type=arrow,tag=teleport_arrow,nbt={inGround:1b}] run kill @e[type=arrow]
...
# Explosive Bow
execute at @a[nbt={SelectedItem:{id:"minecraft:bow",count:1,components:{"minecraft:custom_model_data":2}}}] run tag @e[type=arrow,distance=0..2] add explosive_arrow
