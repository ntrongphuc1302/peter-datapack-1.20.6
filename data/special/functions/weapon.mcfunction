...
# execute as @a[nbt={SelectedItem:{id:"minecraft:bow",count:1,components:{"minecraft:custom_model_data":2}}}] at @s if entity @e[type=arrow,tag=teleport_arrow,nbt={inGround:1b}] run particle minecraft:portal ~ ~0.75 ~ 0.5 0.5 0.5 0.1 100 force

execute as @a[nbt={SelectedItem:{id:"minecraft:bow",count:1,components:{"minecraft:custom_model_data":2}}}] at @s if entity @e[type=arrow,tag=teleport_arrow,nbt={inGround:1b}] run particle minecraft:portal ~ ~0.75 ~ 0.5 0.5 0.5 2 100 force
